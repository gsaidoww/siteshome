...
export default function Search() {
    ...
    return (
        <View>
            <Helmet>
                <html lang="en" />
                <title>Поиск по сайту - Homegeom</title>
                <meta name="description" content="Tutorial for React Helmet" />
                <meta name="theme-color" content="#E6E6FA" />
            </Helmet>
            <HeaderDefaoult />
            <HeaderSmall title={'Поиск по сайту'} />
            {loader == false ?
                <ScrollView style={{ marginTop: windowHeight/120, paddingHorizontal: windowWidth/4.4, width: windowWidth }}>
                    <View>
                        <TextInput 
                            value={text}
                            ...
                            style={{
                                paddingVertical: windowHeight/110, 
                                paddingHorizontal: windowWidth/140, 
                                backgroundColor: '#F2F3F5', width: windowWidth/5, 
                    ...
                    <View style={{ marginTop: windowHeight/20 }}></View>
                </ScrollView>
            :(
